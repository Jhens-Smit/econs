...
<head>
  ...
  <title>MUNICIPALIDAD DISTRITAL DE HUAMANCACA</title>
...
<body class="bg-light">
  ...
  <header class=" text-white py-3" style="background-color: #3ED918;">
    <div class="container d-flex justify-content-between align-items-center">
      <a href="../login.php" class="btn btn-light btn-sm">Volver al inicio</a>
      <h1 class="h3 m-0">MUNICIPALIDAD DISTRITAL DE HUAMANCACA</h1>
